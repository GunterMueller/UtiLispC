...
int _uadd(unsigned int *a, int k, unsigned int x, int n)
{
	unsigned int a0,s0;
	int i=0;
	for(;;){
...
int _usub(unsigned int *a, int k, unsigned int x, int n)
{
	unsigned int a0,d0;
	int i=0;
	for(;;){
...
void _umul(unsigned int *u, int m, unsigned int x, unsigned int *p)
{
	unsigned int k=0;
	unsigned long long y;
	int i;
...
int uadd(int *a, int v, int size)
{
  int rsize=_uadd(a,0,v,size/4);

  return mnorm(a,rsize)*4;
}

int usub(int *a, int v, int size)
{
  int rsize=_usub(a,0,v,size/4);

  return mnorm(a,rsize)*4;
}

int umul(int *a, int asize, int v)
{
  int *b,*c;
...
int mmul(int *a, int asize, int *b, int bsize)
{
  unsigned int *abs_a=a,*abs_b=b,*c;
...
int mdiv(int *a, int asize, int *b, int bsize)
{
...
int mconv(int *a, int asize, int *b)
{
