...
!LLL0:
	...
	.global _mtest
_mtest:				!mtest returns the distance of sadd and ssub
...
msub2:
	...
	.global _uadd
_uadd:				!add one word addend to long augend
...
uadd7:
	...
	.global _usub
_usub:			 	!sub one word subtrahend from long minuend
...
L9:
	...
	.global _umul
_umul:				!multiplier of long * one word
	save %sp,-64,%sp
	add %i0,%i1,%o4
	ld [%o4-8],%l3		!mrflag
	mov 0,%i4		!carry
