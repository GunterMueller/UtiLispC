...
extern int gctype;
#if !defined(HAVE_ETEXT) && defined(HAVE_GET_ETEXT)
extern int *etext;
#endif
...
WORD gc(int, WORD *);
/* muls.s */
int uadd(unsigned int *,int,int);
int usub(unsigned int *,int,int);
int madd(unsigned int *,unsigned int *,int);
int msub(unsigned int *,unsigned int *,int);
int umul(unsigned int *,int,int);
int mmul(unsigned int *,int,unsigned int *,int);
int mdiv(unsigned int *,int,unsigned int *,int);
int mconv(unsigned int *,int,unsigned int *);
/* makecode.c */
